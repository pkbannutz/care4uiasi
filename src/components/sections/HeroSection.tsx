...
export const HeroSection: React.FC = () => {
  ...
  return (
    <section className="relative min-h-screen bg-gradient-to-br from-primary/10 to-accent/10">
      {/* Background Image */}
      ...
      {/* Top Logo */}
      <div className={`absolute top-4 sm:top-6 lg:top-8 left-1/2 transform -translate-x-1/2 z-20 transition-all duration-500 ease-in-out ${
              ...
              <div className="max-w-lg mx-auto lg:mx-0">
                ...
                <div className="flex justify-center lg:justify-start">
                  <Button
                    ...
                    className="text-base sm:text-lg px-6 sm:px-8 py-3 sm:py-4 shadow-lg hover:shadow-xl transform hover:scale-105 transition-all duration-300"
                  >
